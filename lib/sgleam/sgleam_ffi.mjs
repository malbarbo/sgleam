...
// What `echo` prints in front of the value. A module of another file is none of
// the repl's business, and one of its own is named after the input either way:
// the file it wrote is one the user never saw.
