...
// function that runs once. The slot is filled by the run of the input that
// wrote it, so a later read never runs the expression again.
export function repl_memo(index, thunk) {
